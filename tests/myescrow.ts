...
describe("escrow", () => {
  ...
  const program = anchor.workspace.Myescrow;
  ...
  it("Initialize escrow", async () => {
    ...
    console.log('init main account: ', initializerMainAccount.publicKey);
    console.log('escrow account: ', escrowAccount.publicKey);
    console.log('programid account: ', program.programId);
    console.log('tokenpro account: ', TOKEN_PROGRAM_ID);
    console.log('system account: ', anchor.web3.SystemProgram.programId);
    console.log('sysvar account: ', anchor.web3.SYSVAR_RENT_PUBKEY);
    console.log('vault account: ', vault_account_pda);
    console.log('vault authority: ', vault_authority_pda);
